...
public class PassiveCa {
	...
	public void compute_flux(Double I_18) {
		...
		this.flux = -(this.getFcalm()/I_18)*calreg*2*this.goldman.getGoldmanFactor()*((this.medium.Caf.getConcentration()-this.cell.Caf.getConcentration()*Math.exp(2*this.goldman.getGoldmanFactor()))/(1-Math.exp(2*this.goldman.getGoldmanFactor())));
	}
